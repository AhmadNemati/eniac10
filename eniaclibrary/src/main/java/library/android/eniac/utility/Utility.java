...
public class Utility {
    ...
    public static Boolean isNetworkAvailable() {
        ConnectivityManager connectivityManager
                = (ConnectivityManager) SingletonContext.Companion.getInstance().getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
/*
    ...
    public static void share(String body) {
        ...
        SingletonContext.getInstance().getContext().startActivity(Intent.createChooser(sharingIntent, "share"));
...
*/
  ...
  /*      return check.equals("0921") || check.equals("0922");*/
    ...
    public static boolean checkGps() {
        ...
        final LocationManager manager = (LocationManager) SingletonContext.Companion.getInstance().getContext().getSystemService(Context.LOCATION_SERVICE);
